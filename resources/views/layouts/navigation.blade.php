<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                ...
                <x-dropdown align="right" width="32">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('lang.switch', 'de')">🇩🇪 Deutsch</x-dropdown-link>
                    </x-slot>
                </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="border-t border-gray-200 mt-3 pt-3 space-y-1">
            <x-responsive-nav-link :href="route('lang.switch', 'en')">🇬🇧 English</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('lang.switch', 'de')">🇩🇪 Deutsch</x-responsive-nav-link>
        </div>
